...
if choice_menu == "Product Description":
    ...
    st.markdown("#### In-person visits to clinics are too slow to check their progression of Parkinson’s Therapies. We developed “A Multimodal Digital Biomarker Companion for Parkinson’s Therapies”, an application to track and monitor the progression of Parkinson’s Therapies. The patients need only speak “Ahh” to a mobile phone, and our Companion App will immediately tell the patients the progression of the Therapies. Whether patients are in the recovering stage or moving away from healthy people. The progression of the Therapies allows clinicians to adjust treatments dynamically and democratizes access to neurological tracking in under-resourced or rural areas where specialized clinics do not exist.")
